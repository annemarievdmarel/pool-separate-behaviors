...
EXPLORE_refmodeldata <- read.csv(file="EXPLORE-refmodeldata.csv") # file on the EXPLORE_liz github branch is not correct
...
#write.csv(ref.model.strategies, file = paste(dfile.loc, "EXPLORE_SUMM.refmodel.strategies.csv", sep=""))	
