...
```{r}
aggdataXdyad <- observed
aggdata.sumXdyad <- aggdataXdyad  %>% 
...
setdiff(aggdata.sumXdyad,observedXdyad) # check old code from this script (above) with code from summarize ref script (below) --> is the same, I suggest to keep bottom one. 
...
```{r}
head(aggdata.sumXdyad) # name from this script
