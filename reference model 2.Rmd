...
repo.data <- read.csv("EXPLORE-sparse-aggCD.csv")
...
sum(repo.data[,2:ncol(repo.data)] == sample.obs.CD) # should equal to nrows x ncols of the dataframe
...
The summary results of the observed crowds are calculated in the 'summarize ref model and observed data.rmd' file and saved in "EXPLORE-SUMM.observed.csv"
