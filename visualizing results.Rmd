...
beanplot(refmodel.summary$prop.Rcrowd, refmodel.summary$prop.Rdisplace,  
         ...
         col = c("lightgrey", alpha("black", 0.6)), 
...
beanplot(refmodel.summary$Rcrowd.transi.ttri, refmodel.summary$Rdisp.transi.ttri,
         ...
         col = c("lightgrey", alpha("black", 0.6)), 
         ll = 0.1, beanlinewd = 0.1)
points(1,observed.summary$Obcrowd.transi.ttri, col="#fc8d62", pch=7) # crowds
points(2,observed.summary$Obdisp.transi.ttri, col="#8da0cb", pch=7) # displacements
