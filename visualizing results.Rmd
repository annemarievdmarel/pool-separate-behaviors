...
observed.summary.individual<- read.csv("ANALYZE-SUMM.observed.indiviudal.csv")
...
```{r}
# degree
ggplot(refmodel1.summary, aes(x=Rdisp.degree, y=Rcrowd.degree)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   labs(main= "out-degree", x = "displace" , y = "crowd")  +
  theme(legend.position = "none") +
  geom_jitter(data = observed.summary.individual, aes(x = Obdisp.degree, y = Obcrowd.degree), col=alpha(obs.vals, pooled.alpha)) 

  #if in 1 plot
# 
#  geom_line(data = refmodel2.summary, aes(x=Rdisp.degree, y=Rcrowd.degree, #color=factor(run.code)), alpha = .1 ) +
#  geom_smooth(data = refmodel2.summary, aes(x=Rdisp.degree, y=Rcrowd.degree))

ggplot(refmodel2.summary, aes(x=Rdisp.degree, y=Rcrowd.degree)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  scale_color_grey() +
  theme_classic() + 
  #geom_smooth() + 
...
# out strength
plot.ref1.strength<- ggplot(refmodel1.summary, aes(x=Rdisp.strength, y=Rcrowd.strength)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle( "ref model 1" ,subtitle = "out strength") +
  xlab("displace") + 
  ylab("crowd") + 
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) +
  geom_jitter(data = observed.summary.individual, aes(x = Obdisp.strength, y = Obcrowd.strength), col=alpha(obs.vals, pooled.alpha)) 
 # +  annotate(geom="text", x=180, y=180, label= "p crowd = 0.36",
 #              color="black")
plot.ref1.strength

plot.ref2.strength<- ggplot(refmodel2.summary, aes(x=Rdisp.strength, y=Rcrowd.strength)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle("ref model 2", subtitle = "out strength") +
  xlab("displace") + 
  ylab("crowd") + 
 theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) +
  geom_jitter(data = observed.summary.individual, aes(x = Obdisp.strength, y = Obcrowd.strength), col=alpha(obs.vals, pooled.alpha)) 
...
#betweenness
plot.ref1.between <- ggplot(refmodel1.summary, aes(x=Rdisp.between, y=Rcrowd.between)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle("",subtitle = "betweenness centrality") +
  xlab("displace") + 
  ylab("crowd")  +
  theme(legend.position = "none") +
  geom_jitter(data = observed.summary.individual, aes(x = Obdisp.between, y = Obcrowd.between), col=alpha(obs.vals, pooled.alpha)) 
plot.ref1.between

plot.ref2.between <- ggplot(refmodel2.summary, aes(x=Rdisp.between, y=Rcrowd.between)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle("",subtitle = "betweenness centrality") +
...
# eigenvector 
plot.ref1.eigen <- ggplot(refmodel1.summary, aes(x=Rdisp.ec, y=Rcrowd.ec)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle("",subtitle = "eigenvector centrality") +
  xlab("displace") + 
  ylab("crowd")  +
  theme(legend.position = "none") +
  geom_jitter(data = observed.summary.individual, aes(x = Obdisp.ec, y = Obcrowd.ec), col=alpha(obs.vals, pooled.alpha)) 
plot.ref1.eigen


plot.ref2.eigen <- ggplot(refmodel2.summary, aes(x=Rdisp.ec, y=Rcrowd.ec)) +
  geom_jitter(aes(color=factor(run.code)), alpha = .1) +
  theme_classic() + 
  #geom_smooth() + 
   ggtitle("",subtitle = "eigenvector centrality") +
...
plot.indvidual.clr <- ggarrange(plot.ref1.strength, plot.ref2.strength,
                            plot.ref1.between, plot.ref2.between, 
                            plot.ref1.eigen, plot.ref1.eigen, 
                            nrow = 3, ncol = 2)
plot.indvidual.clr
ggexport(plot.indvidual.clr, filename = "plot.individual.clr.pdf")

```


ggplot - reference models in background
...
# degree
plot.degree <- ggplot(data = observed.summary.individual, aes(x = Obdisp.degree, y = Obcrowd.degree)) +
  geom_jitter(data = bg_refmodel1, aes(Rdisp.degree, y = Rcrowd.degree), colour = col.dkgn, alpha = bean.alpha) +
  geom_jitter(col=alpha(obs.vals, pooled.alpha)) +
  theme_classic() + 
  labs(main= "out-degree", x = "displace" , y = "crowd") +
  geom_jitter(data = bg_refmodel2, aes(Rdisp.degree, y = Rcrowd.degree), colour = col.ltgn, alpha = bean.alpha) 

 # theme(legend.position = "none") +
 # geom_jitter(data = observed.summary.individual, aes(x = Obdisp.degree, y = Obcrowd.degree)) +
 #geom_line(data = refmodel2.summary, aes(x=Rdisp.degree, y=Rcrowd.degree, color=factor(run.code)), alpha = .1 ) +
 #geom_smooth(data = refmodel2.summary, aes(x=Rdisp.degree, y=Rcrowd.degree))

# out strength
plot.strength<- ggplot(data = observed.summary.individual, aes(x = Obdisp.strength, y = Obcrowd.strength)) +
...
# betweenness
plot.between<-ggplot(data = observed.summary.individual, aes(x = Obdisp.between, y = Obcrowd.between)) +
...
# eigenvector
plot.eigen<-ggplot(data = observed.summary.individual, aes(x = Obdisp.ec, y = Obcrowd.ec)) +
...
plot.eigen
# other colors: "#FDDBC7" , "#D1E5F0"

plot.indvidual <- ggarrange(plot.strength,
                            plot.between, plot.eigen,
                            nrow = 3, ncol = 1)
plot.indvidual
ggexport(plot.indvidual, filename = "plot.individual.pdf")
```
