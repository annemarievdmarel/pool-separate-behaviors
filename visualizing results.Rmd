...
p.ref1.strength<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val),prop.val) # 2-sided
p.ref1.strength
...
p.ref2.strength<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.strength
...
p.ref1.between <- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.between
...
p.ref2.between<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.between
...
p.ref1.ec <- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.ec
...
p.ref2.ec <- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.ec 
```
...
p.ref1.crowd.apl <- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.apl
...
p.ref1.disp.apl<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.apl
...
p.ref2.apl<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.apl
...
p.ref1.crowd.eff<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.eff
...
p.ref1.disp.eff<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.eff
...
p.ref2.eff<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.eff
...
p.ref1.apl.crowd.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.apl.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.apl.pool
...
p.ref2.apl.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.apl.pool
...
p.ref1.eff.crowd.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.eff.disp.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref2.eff.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.eff.pool
...
p.ref1.crowd.lin<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.lin
...
p.ref1.disp.lin<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.lin
...
p.ref2.lin<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.lin
...
p.ref1.lin.crowd.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.lin.disp.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref2.lin.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.crowd.steep<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.steep
...
p.ref1.disp.steep<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.steep
...
p.ref2.steep<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.steep
...
p.ref1.steep.crowd.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.steep.disp.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref2.steep.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.steep.pool
...
p.ref1.crowd.trans<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.trans
...
p.ref1.disp.trans <- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.trans 
...
p.ref2.trans<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.trans
...
p.ref1.trans.crowd.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref1.trans.disp.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
...
p.ref2.trans.pool<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.trans.pool
...
p.ref1.crowd.den<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.den
...
p.ref1.disp.den<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.den
...
p.ref2.den<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref2.den
...
p.ref1.crowd.sparse<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.crowd.sparse
...
p.ref1.disp.sparse<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
p.ref1.disp.sparse
...
p.ref2.sparse<- ifelse(prop.val>0.025, ifelse(prop.val<0.975, 1-prop.val, prop.val), prop.val) # 2-sided
