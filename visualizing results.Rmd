...
abline(h=observed.summary$obs.cor, col=pooled, lwd = linewidth)  # add line estimate of totalDC 
```
...
points(1,observed.summary$Obcrowd.linearity, col= crowds, pch=19) # crowds
points(2,observed.summary$Obdisp.linearity, col= displace, pch=19) # displacements
points(3,observed.summary$Obcrowd.linearity, col= crowds , pch=19) # crowds
abline(h=observed.summary$ObtotalCD.linearity, col=pooled, lwd = linewidth)  # add line estimate of totalDC 
...
beanplot(refmodel1.summary$Rcrowd.steepness, refmodel1.summary$Rdisp.steepness,refmodel2.summary$Rdisp.steepness,
         ...
         border = 'NA', las=1, ll = 0.1, beanlinewd = 0.1,
         what = c(FALSE, TRUE, TRUE, TRUE)) # remove overall line
points(1,observed.summary$Obcrowd.steepness, col=crowds, pch=19) # crowds
points(2,observed.summary$Obdisp.steepness, col=displace, pch=19) # displacements
points(3,observed.summary$Obcrowd.steepness, col= crowds , pch=19) # crowds
abline(h=observed.summary$ObtotalCD.steepness, col=pooled, lwd = linewidth)  # add line estimate of totalDC 
...
beanplot(refmodel1.summary$Rcrowd.transi.ttri, refmodel1.summary$Rdisp.transi.ttri,
         ...
         border = 'NA', las=1, ll = 0.1, beanlinewd = 0.1,
         what = c(FALSE, TRUE, TRUE, TRUE)) # remove overall line
points(1,observed.summary$Obcrowd.transi.ttri, col= crowds , pch=19) # crowds
points(2,observed.summary$Obdisp.transi.ttri, col= displace, pch=19) # displacements
points(3,observed.summary$Obcrowd.transi.ttri, col= crowds , pch=19) # crowds
abline(h=observed.summary$ObtotalCD.transi.ttri, col=pooled, lwd = linewidth) # add line estimate of totalDC 
...
beanplot(refmodel1.summary$Rcrowd.density, refmodel1.summary$Rdisplace.density, refmodel2.summary$Rdisplace.density,  
         ...
         border = 'NA', las=1, ll = 0.1, beanlinewd = 0.1,
         what = c(FALSE, TRUE, TRUE, TRUE)) # remove overall line
points(1,observed.summary$Obcrowd.density, col=crowds , pch=19) # crowds
points(2,observed.summary$Obdisplace.density, col=displace, pch=19) # displacements
points(3,observed.summary$Obcrowd.density, col=crowds , pch=19) # crowds
abline(h=observed.summary$ObtotalCD.density, col=pooled, lwd = linewidth) # add line estimate of totalDC
...
beanplot(refmodel1.summary$Rcrowd.prunk.pu, refmodel1.summary$Rdisp.prunk.pu,refmodel2.summary$Rdisp.prunk.pu,
        ...
        xlab = "", names = xlabels, col = beancolor, 
         border = 'NA', las=1, ll = 0.1, beanlinewd = 0.1,
         what = c(FALSE, TRUE, TRUE, TRUE)) # remove overall line
points(1,observed.summary$Obcrowd.prunk.pu, col=crowds , pch=19) # crowds
points(2,observed.summary$Obdisp.prunk.pu, col=displace, pch=19) # displacements
points(3,observed.summary$Obcrowd.prunk.pu, col=crowds , pch=19) # crowds
abline(h=observed.summary$ObtotalCD.prunk.pu, col=pooled, lwd = linewidth)  # add line estimate of totalDC 
