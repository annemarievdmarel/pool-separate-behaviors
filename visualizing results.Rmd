...
```{r}
# set color and other parameters
beancolor<- list(alpha("#8da0cb", 0.6),c(alpha("#fc8d62", 0.6)), alpha("#fc8d62"))
crowds <- "#8da0cb"
displace <- "#fc8d62"
pooled <- "grey"
linewidth <- 2
...
beanplot(refmodel1.summary$Rcrowd.transi.ttri, refmodel1.summary$Rdisp.transi.ttri,
         ...
         ylim=c(min(refmodel1.summary$Rdisp.transi.ttri-0.1), 
                max(refmodel1.summary$Rdisp.transi.ttri,refmodel2.summary$Rdisp.transi.ttri+0.1)),
         xlab = "", names = xlabels, col = beancolor, 
         border = 'NA', las=1, ll = 0.1, beanlinewd = 0.1,
         what = c(FALSE, TRUE, TRUE, TRUE)) # remove overall line
