...
ref.model.strategies <- read.csv("EXPLORE_SUMM.refmodel.strategies.csv")
...
ggplot(strategies, aes(x=behavior, y=n, fill=strategy)) +
  ...
  annotate("point", 2,25, col="white", pch=23, cex=4, bg="blue") + # displace  
  annotate("point",1,75, col="white", pch=23, bg="lightgrey", cex=4) + # crowd
  annotate("point",1.5,55, col="white", pch=23,bg="lightgrey", cex=4)     # total DC
```
