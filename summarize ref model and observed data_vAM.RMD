...
#WRITE DATA (change to own location)
dfile.loc <- "C:/Users/Liz/Dropbox/A ACTIVE MSs/2020-05 Pool vs separate behaviors/pool-separate-behaviors/" # change to own location
#write.csv(ref.model.summaries, file = paste(dfile.loc, "EXPLORE-SUMM.refmodel.csv", sep=""))	

write.csv(refmodel.summary, file = "EXPLORE-SUMM.refmodel_vAM.csv")
