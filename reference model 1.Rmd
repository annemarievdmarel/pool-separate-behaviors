...
EXPLORE_refmodeldata <- read.csv(file="EXPLORE-refmodeldata.csv")# reference model data
head(EXPLORE_refmodeldata)
ref.model <- EXPLORE_refmodeldata 
...
#WRITE DATA
write.csv(ref.model.strategies, file = "EXPLORE_SUMM.refmodel.strategies.csv", sep="")	write.csv(ref.model.blurdata, file = "EXPLORE_SUMM.refmodel.blurs.csv", sep="")
```
