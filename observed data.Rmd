...
hist(observed.ID$Obcrowd.strength) # normal distribution?
hist(observed.ID$Obdisp.strength)
plot(observed.ID$Obcrowd.strength,observed.ID$Obdisp.strength)  # linear relationship?

obs.cor.strength <- cor(observed.ID$Obcrowd.strength, observed.ID$Obdisp.strength, 
               method = "spearman")
...
hist(observed.ID$Obcrowd.between) # normal distribution?
hist(observed.ID$Obdisp.between)
plot(observed.ID$Obcrowd.between,observed.ID$Obdisp.between)  # linear relationship?

obs.cor.between <- cor(observed.ID$Obcrowd.between, observed.ID$Obdisp.between, 
               method = "spearman")
...
hist(observed.ID$Obcrowd.ec) # normal distribution?
hist(observed.ID$Obdisp.ec) # linear relationship?
plot(observed.ID$Obcrowd.ec,observed.ID$Obdisp.ec) 

obs.cor.eigen <- cor(observed.ID$Obcrowd.ec, observed.ID$Obdisp.ec, 
               method = "spearman")
