...
dyads.interacting <- dyads.interacting %>%
  mutate(percentage = n.dyads/420*100)
...
# normal distribution?
hist(observedXdyad.alldyads$observed.crowd)
hist(observedXdyad.alldyads$observed.displace)
# linear relationship?
plot(observedXdyad.alldyads$observed.crowd,observedXdyad.alldyads$observed.displace) 

obs.cor <- cor(observedXdyad.alldyads$observed.crowd, observedXdyad.alldyads$observed.displace, method = "spearman")

cor.test(observedXdyad.alldyads$observed.crowd, 
         observedXdyad.alldyads$observed.displace, 
         method = "spearman",
         exact = FALSE)
