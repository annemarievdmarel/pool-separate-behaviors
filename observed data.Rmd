...
## combine
interaction <- c("crowd", "displace", "both", "total ag. dyads" , "none","total")
n.dyads <- c(length(unique.crowds$observed.crowd), length(unique.displace$observed.displace),  length(dyads.CD$actor), n.dyads.CD, length(null.dyads$actor), length(observedXdyad.alldyads$actor))
